...
@section('content')
        ...
        @foreach($orders as $key=>$order)
            <tr>
                ...
                <td class="center" style="padding-top: 20px">
                    <a href="{{route('order.detail',$order->id)}}" role="button" class="blue" data-toggle="modal" data-value="{{$order->id}}">
                        {{$order->name}}
                    </a>
                </td>
                <td class="center" style="padding-top: 20px">{{$order->created_at}}</td>
                <td class="center" style="padding-top: 20px" >{{$order->books_count}}</td>
                <td class="center" style="padding-top: 20px" >{{$order->user->name}}</td>
                <td class="center" style="padding-top: 20px" >{{$order->address}}</td>
                <td class="center" style="padding-top: 20px" >{{'$'.$order->ship_cost}}</td>
                <td class="center" style="padding-top: 20px" >{{'$'.$order->total}}</td>
                <td class="center" style="padding-top: 20px" >Deleted</td>

                <td class="center" style="padding-top: 20px" hidden id="bookId" data-value="{{$order->id}}">{{'MSB-'.$order->id}}</td>
                <td class="center" style="padding-top: 20px">
                    <div class="hidden-sm hidden-xs btn-group">
                        <a class="btn btn-xs btn-info" href="{{route('orders.restore',$order->id)}}"><i
                            class="ace-icon fa fa-recycle bigger-120"></i>Restore</a>
                    </div>
    ...
    {{--order detail modal--}}
{{--
        <div id="orderDetail-modal-form" class="modal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
