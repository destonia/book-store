                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select style="width: 187px" name="category_id[]" multiple="multiple"
                                                ...
                                                @if(!$errors->has('license_no'))
                                                    <span>
												<input type="number" id="form-field-icon-1" name="license_no" value="{{old('license_no')}}"/>
											</span>
                                                @else
                                                    <span>
												<input style="border: solid red" type="text" id="form-field-icon-1"
                                                ...
                                                @if(!$errors->has('price'))
                                                    <span>
												<input type="number" id="form-field-icon-1" name="price" value="{{old('price')}}"/>
											</span>
                                                @else
                                                    <span>
												<input style="border: solid red" type="text" id="form-field-icon-1"
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select style="width: 187px" name="author_id[]" multiple="multiple"
                                                ...
                                                @if(!$errors->has('republish_no'))
                                                    <span>
												<input type="number" id="form-field-icon-1" name="republish_no" value="{{old('republish_no')}}"/>
											</span>
                                                @else
                                                    <span>
												<input style="border: solid red" type="text" id="form-field-icon-1"
                                                ...
                                                @if(!$errors->has('isbn_no'))
                                                    <span>
												<input type="number" id="form-field-icon-1" name="isbn_no" value="{{old('isbn_no')}}"/>
											</span>
                                                @else
                                                    <span>
                                                ...
                                                @if(!$errors->has('qty'))
                                                    <span>
												<input type="number" id="form-field-icon-1" name="qty" value="{{old('qty')}}"/>
											</span>
                                                @else
                                                    <span>
                                                ...
                                                @if(!$errors->has('pages'))
                                                    <span>
												<input type="number" id="form-field-icon-1" name="pages"  value="{{old('pages')}}">
											</span>
                                                @else
                                                    <span>
