    ...
    <table id="simple-table" class="table  table-bordered table-hover">
        ...
        @foreach($order->orderDetails as $key=>$item)
            <tr>
                ...
                <td class="left"><img src="{{asset('storage/'.$item->book->avatar)}}"
                                      style="height: 50px;padding-right: 20px" alt="">{{$item->book->name}}</td>
                <td class="center"
                    style="padding-top: 20px">@foreach($item->book->authors as $author){{$author->name.' ,'}}@endforeach</td>
                <td class="center" style="padding-top: 20px">{{$item->book->isbn_no}}</td>
                <td class="center" style="padding-top: 20px">{{$item->book->publisher}}</td>
                <td class="center" style="padding-top: 20px">{{$item->book->publish_date}}</td>
                <td class="center" style="padding-top: 20px">{{$item->book->republish_no}}</td>
                <td class="center" style="padding-top: 20px">${{$item->book->price}}</td>
                <td class="center" style="padding-top: 20px">{{$item->quantity}}</td>
            </tr>
        @endforeach
        </tbody>
    </table>
