        ...
        <div class="col-sm-12 text-center">
            ...
            <div class="widget-box">
                <div class="widget-header">
                    <h4 class="widget-title">Edit Book</h4>
                </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select style="width: 187px" name="category_id[]" multiple="multiple"
                                                ...
                                                @if(!$errors->has('license_no'))
                                                    <span>
												<input type="number" id="form-field-icon-1" name="license_no" value="{{$book->license_no}}"/>
											</span>
                                                @else
                                                    <span>
												<input style="border: solid red" type="text" id="form-field-icon-1"
                                                ...
                                                @if(!$errors->has('price'))
                                                    <span>
												<input type="number" id="form-field-icon-1" name="price" value="{{$book->price}}"/>
											</span>
                                                @else
                                                    <span>
												<input style="border: solid red" type="text" id="form-field-icon-1"
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select style="width: 187px" name="author_id[]" multiple="multiple"
                                                ...
                                                @if(!$errors->has('republish_no'))
                                                    <span>
												<input type="number" id="form-field-icon-1" name="republish_no" value="{{$book->republish_no}}"/>
											</span>
                                                @else
                                                    <span>
												<input style="border: solid red" type="text" id="form-field-icon-1"
                                                ...
                                                @if(!$errors->has('isbn_no'))
                                                    <span>
												<input type="number" id="form-field-icon-1" name="isbn_no" value="{{$book->isbn_no}}"/>
											</span>
                                                @else
                                                    <span>
												<input style="border: solid red" type="text" id="form-field-icon-1"
                                                ...
                                                @else
                                                    <span>
												<input style="border: solid red" type="number" id="form-field-icon-1"
                                                       name="qty"/>
											</span>
                                                ...
                                                @if(!$errors->has('pages'))
                                                    <span>
												<input type="number" id="form-field-icon-1" name="pages" value="{{$book->pages}}">
											</span>
                                                @else
                                                    <span>
												<input style="border: solid red" type="text" id="form-field-icon-1"
