...
@section('breadcrumb')
    <div class="row">
        ...
        <div class="nav-search col-sm-4" id="nav-search" style="text-align: right">
            <form class="form-search" action="{{route('categories.search')}}" method="post">
                @csrf
...
@section('content')
                ...
                <tr>
                    ...
                    <td class="center" style="padding-top: 5px">
                        <div class="hidden-sm hidden-xs btn-group">
                            ...
                            <a class=" btn btn-xs btn-info edit-button" href="#edit-modal-form" data-toggle="modal" role="button"><i
                                    class="ace-icon fa fa-pencil bigger-120"></i></a>
                            <a class="btn btn-xs btn-danger delete-btn" href="{{route('categories.delete',$category->id)}}"><i
            ...
            <div class="modal-content">
                ...
                <form action="{{route('categories.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="ajaxSubmit" type="submit" class="btn btn-sm btn-primary">
    ...
    {{--edit modal--}}
    <div id="edit-modal-form" class="modal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12">
                                <div class="form-group">
                                    <label for="name">Category's Name</label>
                                    <div>
                                        <input class="col-sm-12" name="name" type="text" id="edit-name"/>
                                    </div>
    ...
    <script language="JavaScript" type="text/javascript">
        $(document).ready(function () {
            $('.delete-btn').click(function (e) {
                ...
                if (!confirm('Are you sure deleting Category: ' + categoryName)) {
                    e.preventDefault();
                    return false;
                }
                return true;
